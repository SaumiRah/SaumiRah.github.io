...
*<u>Note from the future</u>: If I were to tackle this project today I would approach the task much differently: I would employ a more conrete naming convention for variables and files, use version control, and would overall use more functions for DRYer code. I include this project here because it served as an important learning opportunity for me, and demonstrates that I've solved a real-world assignment.*
...
![](<Change over Time Graphs/Observations (n)/Proportional observation differences over consecutive years.jpeg>)
...
![](<Change over Time Graphs/Mean and SD/Difference in Nominal Tariff SDs arranged by category over consecutive years.jpeg>)