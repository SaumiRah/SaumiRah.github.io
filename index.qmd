...
:::{#second-column}
<div id="doodle-wrap" class="doodle-wrap">
<img id="doodle-image" src="img/selfie_cropped.jpg" width="250" class="img-fluid" alt="Saumi Rahnamay">
<canvas id="doodle-canvas" class="doodle-canvas"></canvas>
<button id="doodle-toggle" class="doodle-toggle" type="button" aria-pressed="false" title="Doodle on this photo">✏️</button>
</div>
:::
